...
const IconSVG = () => {
    return (
        ...
        width="100" height="100" style={{position:"relative"}}
        viewBox="0,0,256,256">
...
return (
    ...
    >
        ...
        {(loading || show) ? ( 
                <iframe width="100%" height="100%" style={{borderRadius: '25px'}} src={`${videoURL}?autoplay=1`} frameborder="0"></iframe>
        ) : (
            <div style={{
                position: "relative",
                width: "100%",
