    ...
    return (
      <section className={`flex flex-col ${block.theme}`}>
        <div className="bg-[var(--secondary)] py-4">
          <h1 className="text-3xl text-center"><SafeHtml className={"!text-[var(--on\\_secondary)]"} value={main.header?.title}/></h1>
          <h2 className="text-xl text-center"><SafeHtml className={"!text-[var(--on\\_secondary)]"} value={main.header?.subtitle}/></h2>
        </div>
        <div className="flex flex-col lg:flex-row justify-between bg-[var(--secondary)]">
              ...
              <blockquote className="mt-6 md:flex md:flex-grow md:flex-col">
                <div className="relative text-lg font-medium md:flex-grow">
                  ...
                  <p className="relative" >
                    <SafeHtml value={testimonial.quote} as="h1" className=" !text-[var(--on\\_secondary)]"/>
                  </p>
                </div>
                <footer className="mt-8">
                  <div className="flex items-start">
                    <div className="inline-flex flex-shrink-0 border-2 border-[var(--on\\_secondary)] rounded-full">
                      <Image 
                        profile={profile}
                    ...
                    <div className="ml-4">
                      <div className="text-base font-medium">
                        <SafeHtml value={testimonial.name} as="h2" className=" !text-[var(--on\\_secondary)]"/>
                      </div>
                    </div>
                  </div>
                </footer>
